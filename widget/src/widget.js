...
(function () {
  ...
  function iconTwogis() {
    // Official 2GIS brand icon (green/yellow/blue mark)
    return `<svg width="20" height="20" viewBox="18 12 24 24" fill="none" aria-hidden="true"><mask id="ql2gm" x="18" y="12" width="24" height="24" maskUnits="userSpaceOnUse"><path d="m23.965 12.01 1.025-.01 10.681.004c.162.002.263.004.364.007.53.014 1.063.045 1.587.138a5.384 5.384 0 0 1 1.509.491 5.063 5.063 0 0 1 2.218 2.194c.247.477.402.966.498 1.491.094.518.125 1.046.14 1.57.006.24.01.48.01.72l.002.429v9.48c0 .286 0 .571-.002.857 0 .24-.004.48-.01.72a10.34 10.34 0 0 1-.14 1.57 5.233 5.233 0 0 1-.498 1.492 5.012 5.012 0 0 1-.933 1.27 5.07 5.07 0 0 1-1.285.923 5.384 5.384 0 0 1-1.509.492c-.523.093-1.058.124-1.587.138l-1.596.012-10.112-.006a19.69 19.69 0 0 1-.363-.006 10.685 10.685 0 0 1-1.588-.138 5.382 5.382 0 0 1-1.508-.492 5.062 5.062 0 0 1-2.22-2.193 5.258 5.258 0 0 1-.497-1.492 10.326 10.326 0 0 1-.139-1.57c-.007-.24-.01-.48-.01-.72l-.002-.428v-9.481c0-.286 0-.571.002-.856.001-.24.004-.481.011-.721.014-.524.045-1.052.14-1.57a5.256 5.256 0 0 1 .497-1.491 5.054 5.054 0 0 1 2.219-2.193 5.382 5.382 0 0 1 1.508-.492 10.699 10.699 0 0 1 1.588-.138z" fill="#fff" fill-rule="evenodd" clip-rule="evenodd"/></mask><g mask="url(#ql2gm)"><path d="m18 12h24v24h-24z" fill="#19aa1e"/><path d="m18 12h24v7.875l-24-3.75z" fill="#ffb919"/><path d="m18 33.374 24-3.75v6.375h-24z" fill="#82d714"/><path d="m18 15.65 8.377 1.308c1.043-.66 2.284-1.022 3.623-1.022 1.855 0 3.52.695 4.734 1.914.153.154.297.315.432.482l6.834 1.067v.95l-6.14-.96c.456.875.703 1.85.703 2.846 0 1.286-.288 2.568-.883 3.855l-.018.039-.252.54h-.597c-1.233 0-2.051.37-2.586 1.023-.42.513-.662 1.205-.744 1.96l-.003.024-.011.12-.006.053-.01.102a19.06 19.06 0 0 0-.062.856l10.609-1.657v.95l-24 3.75v-.95l10.62-1.66-.004-.212-.001-.06-.001-.031-.002-.048a19.26 19.26 0 0 0-.07-.99l-.008-.076-.013-.132c-.076-.759-.316-1.46-.734-1.98-.53-.658-1.34-1.033-2.563-1.04h-.634l-.252-.541c-.607-1.3-.9-2.595-.9-3.894a6.235 6.235 0 0 1 1.93-4.485l-7.368-1.153v-.949z" fill="#fff" fill-rule="evenodd" clip-rule="evenodd"/><path d="m30 16.874c3.35 0 5.625 2.579 5.625 5.361 0 1.117-.244 2.28-.812 3.498-3.297 0-4.111 2.36-4.265 3.846l-.01.1a17.3 17.3 0 0 0-.09 1.276l-.893.14v-.03a17.108 17.108 0 0 0-.096-1.415l-.003-.026c-.142-1.482-.938-3.891-4.269-3.891-.568-1.219-.812-2.381-.812-3.498 0-2.782 2.274-5.361 5.625-5.361z" fill="#0073fa" fill-rule="evenodd" clip-rule="evenodd"/></g></svg>`;
  }
